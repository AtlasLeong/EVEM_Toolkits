...
3. Wire the formatter into TrendStats; keep original full formatter for exact title and visually hidden text. Add ISK group label. Use reflowing grid without ellipsis.
